...
private extension ProfileViewController {
    ...
    func setupLayout() {
        ...
        actionsCardView.addSubviews(clearDataButton, logoutButton)
        ...
        activityIndicator.snp.makeConstraints {
            $0.center.equalTo(statsStack.snp.center)
        }
    }
    ...
    func updateUI() {
        Task {
            do {
                ...
                self.activityIndicator.stopAnimating()
                viewModel.onError?(error.localizedDescription)
            }
        }
    }
    ...
    func updateButtonColors(for style: UIUserInterfaceStyle) {
...
private extension ProfileViewController {
    enum Constants {
        ...
        static let languageHieght: CGFloat = 123
        static let themeHeight: CGFloat = 151
    }
}
